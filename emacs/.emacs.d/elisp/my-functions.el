...
(defun my-clockin-tick ()
  (let ((elapsed (- (time-to-seconds) my-clockin-start )))
    (when (and (not my-clockin-notified-30) (> elapsed 1800))
      (setq my-clockin-notified-30 t)
      (my-notify "Clock" "30 Minutes mark"))

    (when (and (not my-clockin-notified-40) (> elapsed 2400))
      (setq my-clockin-notified-40 t)
      (my-notify "Clock" "40 Minutes mark"))

    (when (and (not my-clockin-notified-50) (> elapsed 3000))
      (setq my-clockin-notified-50 t)
      (setq my-clockin-last-overtime-notification (time-to-seconds))
      (my-notify "Clock" "50 Minutes mark"))
    (when (and my-clockin-last-overtime-notification (> (- (time-to-seconds) my-clockin-last-overtime-notification) 15))
      (setq my-clockin-last-overtime-notification (time-to-seconds))
