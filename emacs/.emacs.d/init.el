...
(use-package consult
  ...
  (unless ( boundp 'consult-ripgrep-args )
...
(use-package shackle
  :ensure t
  :config
  (setq shackle-rules '((magit-status-mode :align below :inhibit-window-quit t :select t :size 0.25)
                        (helpful-mode :select t :align below :size 0.3)
                        ...
                        (racket-describe-mode :select t :align below :size 0.3)
                        ...
                        ("*Flycheck errors*" :select t :align below :size 0.3)
                        (cider-repl-mode :select t :align below :size 0.3)
...
(use-package racket-mode
  ...
  (setq racket-xp-unused-face  '(inherit default))
